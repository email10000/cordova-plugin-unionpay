...
public class Unionpay extends CordovaPlugin {
    ...
    public final static String RESULT_SUCCESS_MESSAGE = "1";
    public final static String RESULT_FAIL_MESSAGE    = "0";
    public final static String RESULT_CANCEL_MESSAGE  = "9";
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if ("pay".equals(action)) {
            try {
                ...
                UPPayAssistEx.startPay(cordova.getActivity(), null, null, tn, mMode);
            } catch (Exception e) {
